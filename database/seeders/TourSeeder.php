...
class TourSeeder extends Seeder
{
    public function run()
    {
        $tours = [
            [
                'title' => 'Тур по Горному Алтаю "Золотые горы"',
                'short_description' => 'Невероятное путешествие по самым живописным местам Горного Алтая',
            ...
            [
                'title' => 'Алтай: Озера и водопады',
                'short_description' => 'Тур по самым красивым озерам и водопадам Алтая',
            ...
            [
                'title' => 'Экстрим тур "Алтайские вершины"',
                'short_description' => 'Экстремальное восхождение на горные вершины Алтая',
        ...
        foreach ($tours as $tourData) {
            ...
            // Добавляем изображения для тура
